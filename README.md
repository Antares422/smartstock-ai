...
# 2. 配置数据库
mysql -u root -p%yourpassword% -e "CREATE DATABASE smartstock_ai DEFAULT CHARACTER SET utf8mb4;"
...
- [ 技术架构文档](./doc/03-技术架构文档.md) - 系统架构设计（待编写）
- [ 数据库设计](./doc/04-数据库设计.md) - 数据库表结构（待编写）
